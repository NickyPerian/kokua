...
private:
	...
	static bool readUISoundValue(Parser& parser, void* val_ptr);
	...
	static bool writeUISoundValue(Parser& parser, const void* val_ptr, const name_stack_t&);
...
private:
	...
	static bool readUISoundValue(Parser&, void* val_ptr);
